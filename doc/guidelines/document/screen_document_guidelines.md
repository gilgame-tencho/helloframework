...
```markdown
| 画面ID | 画面名 | 大分類 | 中分類 | 責務 | 最終Feature | 版数 |
|---------|---------|---------|---------|---------|---------|---------|
| S001 | スプラッシュ | 認証 | 起動 | アプリ起動制御 | F-AUTH-001 | v1.0 |
| S002 | ログイン | 認証 | ログイン | 認証実行 | F-AUTH-001 | v1.0 |
| S101 | 営業ホーム | 営業 | ホーム | 営業業務起点 | F-POINT-001 | v1.2 |
```
