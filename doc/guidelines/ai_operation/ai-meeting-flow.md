...
#### 進め方
1. 書記が対象ドキュメントの内容を把握する
2. レビュア１人目が指摘を出す
3. 書記が反映可否を判断し、作業版に反映する
4. レビュア２人目が反映後の作業版をレビューする
5. 以降、レビュア人数分繰り返す
6. 最後に、書記が最終版ドキュメント、変更履歴、未解決事項を出力する

なお、生成AIの処理能力低下防止の観点から、
レビュアが５人以上の場合は最大５人単位で解答を区切ること。
